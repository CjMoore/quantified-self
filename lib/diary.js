...
const Diary = class Diary {
  ...
  getPrevious() {
    ...
    $('#Breakfast-remaining-calories').text(400)

    $('#Dinner-total-calories').text(0)
    $('#Dinner-remaining-calories').text(800)

    $('#Lunch-total-calories').text(0)
    $('#Lunch-remaining-calories').text(600)

    $('#Snacks-total-calories').text(0)
    $('#Snacks-remaining-calories').text(200)

    $('#consumed-calories').text(0)
    $('#remaining-calories').text(2000)
